          ...
          <div className="row row-cols-2">
            <div className="col custom-margin">
              ...
              <div className="cnpj">
                ...
                <p className="mb-0">Web-site: <a href="https://www.g8online.com.br" target="_blank" rel="noopener noreferrer">https://www.g8online.com.br</a></p>
                <p className="mb-0">E-mail: <a href="mailto:g8@g8online.com.br" target="_blank" rel="noopener noreferrer">g8@g8online.com.br</a></p>
              </div>
            </div>
            <div className="col" id="logo-certified">
              <img src={certifiedLogo} width="130" height="130" alt="Certified Logo" />
